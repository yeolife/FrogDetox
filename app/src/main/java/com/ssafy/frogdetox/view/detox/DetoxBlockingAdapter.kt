...
class DetoxBlockingAdapter(var list: MutableList<AppInfoDto>): RecyclerView.Adapter<DetoxBlockingAdapter.CustomViewHolder>() {
    inner class CustomViewHolder(private var itemView: View): RecyclerView.ViewHolder(itemView) {
        fun bind(item: AppInfoDto) {
//            itemView.findViewById<ImageView>(R.id.iv_appIcon)
